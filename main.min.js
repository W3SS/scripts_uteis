    ...
    var verificar_precos_produto_filho = function(self, pai) {
        ...
        if (float_preco_promocional >= float_preco_venda) {
            ...
            if (!$('.error-preco', parent).length) {
                msg = error_msg.replace(":mensagem:", "O preÃ§o promocional nÃ£o pode ser maior ou igual que o preÃ§o de venda.");
    ...
    var completar_imagens_vazias = function () {
        ...
        if (total_imagens < 4) {
            for (var i = 0; i < 4 - total_imagens; i++) {
                // Adicionando os itens vazios necessÃ¡rios.
    ...
    if ($("#uploadImagemProduto").length && !$.browser.msie) {
        $(document).bind('dragover', function (e) {
            ...
            if (!timeout) {
                ...
                // sÃ³ vamos colocar o overlay se a
...
validar_dominio = function(dominio) {
    regex_dominio = /^([a-z0-9Ã¡Ã©Ã­Ã³ÃºÃ¢ÃªÃ®Ã´Ã»Ã¼Ã Ã§Ã£Ãµ]([a-z0-9Ã¡Ã©Ã­Ã³ÃºÃ¢ÃªÃ®Ã´Ã»Ã¼Ã Ã§Ã£Ãµ\-]{0,61}[a-z0-9])?\.)+[a-z-]{2,}$/;
...
$(document).ready(function() {
    if (typeof track == "undefined") {
        alert("track Ã© undefined");  // SerÃ¡ mostrado
    } else {
        var data_json = {
            "track" : track
        }
...
$(document).ready(function() {
	...
	if ($('body').hasClass('loja-gratuita')) {
	    ...
	    if (screen.width < 768) {
	        ...
	        var confirmpro = confirm("VocÃª estÃ¡ acessando a versÃ£o web. Para utilizar a versÃ£o mobile da sua loja, mude para o plano PRO. Deseja mudar agora?");
		    if (confirmpro == true) {
...
function offlineZopim() {
  $.fancybox({
    type: 'inline',
    content: '<div class="text-justify" style="font-weight: 600;">O chat foi um importante aliado no pronto atendimento! Contudo, a maioria dos atendimentos tÃ©cnicos precisam de uma verificaÃ§Ã£o do time de desenvolvedores, o que leva um pouco mais de tempo na anÃ¡lise, comprometendo a velocidade e experiÃªncia no atendimento via chat online.<br /><br />Portanto, a partir de agora, concentraremos nossos atendimentos via Chamado.<br /><br /><div class="text-center"><a href="https://suporte.lojaintegrada.com.br/hc/pt-br/requests/new" target="_blank" class="btn btn-success">Abrir chamado</a></div></div>',
    autoHeight: true,
    minHeight: 10,
    maxWidth: 300,
    minWidth: 280
