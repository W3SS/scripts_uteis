        ...
        Ordenar.prototype.init = function(elemento_pai, elemento_mover, elemento_nome, url_save) {
            ...
            /*
             * Popula posicoes_iniciais com os idÂ´s dos elementos na ordem inicial.
             */
                ...
                $.post(this.url_save, {
                        ...
                        function(data) {
                            if (data.estado == 'SUCESSO') {
                                // Atualiza posicoes_inicias quando não salvo.
                    ...
                    .fail(function() {
                        fnSalvar({
                            estado: 'ERRO',
                            mensagem: 'Não foi possível salvar as alterações. Por favor, entre em contato com nossa equipe de suporte!'
                        });
                    });
            } else {
                fnSalvar({
                    estado: 'SUCESSO',
                    mensagem: 'Não foi feita nenhuma alteração.'
                })
            }
        }
